    ...
    public function afficherMatch($choix,$element)
    {
        ...
        if (count($prono_id) == 0){
            ...
            $matchs = DB::table('matchs')
                ...
                ->leftJoin('pronostics', function($join) use ($userId)
                {
                    $join->on('matchs.id', '=', 'pronostics.match_id');
                    $join->on('pronostics.user_id', '=', DB::raw("'".$userId."'"));
                })
            ...
            if ($key != '_token'){
                ...
                //dd($match_id);
                    ...
                    if ($num == 2 ){
                        ...
                        if ($prono->pronostic1 != null && $prono->pronostic2 != null && $prono->user_id != null && $prono->match_id){
                            $prono->save();
                        }
                    }
                }
