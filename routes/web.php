...
Route::put('/tchat', 'HomeController@tchat')->middleware('auth');
...
Route::get('pronostic/direct', 'DirectController@afficherDirect');
Route::get('pronostic/historique', 'DirectController@afficherHistorique');
