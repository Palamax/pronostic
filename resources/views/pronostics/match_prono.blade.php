    ...
    @foreach ($matchs as $match)
        ...
        <p  class = "row">
                ...
                <span class="  mt-2 pr-0  col-md-3 text-right col-3" >
                    <a class = "mr-1 @if ($index1=='') text-nowrap @endif" href = "/pronostic/equipes/{{$match->id1}}" style="color:black" >{{$equipe1}}</a>
        ...
        <!--</span>--></span>
                ...
                <img  class = "my-1 d-none d-sm-block" src = "img/country/{{$match->equipe2}}.png" style = "float:left">
                    <a class = "ml-1 @if ($index2=='') text-nowrap @endif" href = "/pronostic/equipes/{{$match->id2}}" style="color:black;">{{$equipe2}}</a>
                </span>
