        ...
        @foreach ($matchs as $match)
            ...
            <p  class = "row">
                ...
                <span class="  mt-2 pr-0  col-3 text-right" >
                    <a class = "mr-1" href = "/pronostic/equipes/{{$match->id1}}" style="color:black;" >{{$match->equipe1}}</a>
                    <img class = "mb-1"  src = "img/country/{{$match->equipe1}}.png" >
                </span>
                <span class = "col-2 text-center ">
                    <a class = "text-dark" href = "/pronostic/pronostics/pronostics_groupe/{{$match->id}}">
                ...
                <a class = "mr-1" href = "/pronostic/equipes/{{$match->id2}}" style="color:black">{{$match->equipe2}}</a>
                </span>
                @if(!is_null($match->resultat1))
