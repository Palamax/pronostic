...
@section('content')
<a  href="/pronostic/admin/users" class = "btn btn-secondary">Retour</a>
	...
	{!! Form::open(['action' => ['AdminController@user_update', $user->id], 'method' => 'POST']) !!}
			...
			<div class="form-group">	
				{{Form::label('isActif', 'isActif')}}
				{{form::text('isActif', $user->isActif, ['class' => 'form-control', 'placeholder' => 'isActif'])}}
			</div>			
